...
class Trainer:
    ...
    def __init__(
        ...
        if args.torchdynamo:
            ...
            def get_wrapper():
                # Normal
                return torchdynamo.optimize(args.torchdynamo)

            self.torchdynamo_wrapped_compute_loss = get_wrapper()(self.__compute_loss)
        else:
            self.torchdynamo_wrapped_compute_loss = self.__compute_loss
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        return self.torchdynamo_wrapped_compute_loss(model, inputs, return_outputs)

    def __compute_loss(self, model, inputs, return_outputs=False):
        """
